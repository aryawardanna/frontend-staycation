            ...
            <section className="container">
                <div className="row align-items-center">
                    ...
                    <div className="col">
                        ...
                        <h5 className="h2 font-wight-light line-weight-2 my-3">
                            {data.content}
                        </h5>
                        ...
                        <div>
                            <Button className="btn px-5" style={{ marginTop: 40 }} hasShadow isPrimary type="link" href={`/testimoial/${data._id}`}>
                                Read Their Story
                        </Button>
                        </div>
                    </div>
